...
public:
	void build() override
	{
		cout << "Пишем код в текстовм редакторе" << endl;
	}
	void execute() override
	{
...
public:
	...
	{
		cout << "Получаем оплату за выполненную работу сразу" << endl;
	}
};
...
//freelancer->getSalary();
//cout << endl;
//Programmer* officeProger = new OfficeProgrammer(new HTMLLanguage);
//officeProger->doWork();
